      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="资料名称" prop="ziliaomingcheng">
          <el-input v-model="ruleForm.ziliaomingcheng" 
              placeholder="资料名称" clearable  :readonly="ro.ziliaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资料名称" prop="ziliaomingcheng">
              <el-input v-model="ruleForm.ziliaomingcheng" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="资料视频" prop="ziliaoshipin">
          <file-upload
          tip="点击上传资料视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaoshipin" label="资料视频" prop="ziliaoshipin">
            <el-button type="text" size="small" @click="download(ruleForm.ziliaoshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fuxiziliao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fuxiziliaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
